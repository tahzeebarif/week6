    ...
    <div className="flex items-center justify-center min-h-screen bg-[#F2F0F1] px-4 font-satoshi">
      <div className="w-full max-w-md bg-white rounded-[20px] shadow-sm p-8 md:p-10">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <button
            type="submit"
            className="w-full bg-black text-white font-medium py-4 rounded-full mt-2 hover:bg-black/90 transition-all active:scale-95 shadow-lg shadow-black/10"
          >
            Sign In
          </button>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-black/40 font-bold">Or continue with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-3">
             <a 
               ...
               className="flex items-center justify-center gap-3 w-full border border-gray-200 py-3.5 rounded-full hover:bg-gray-50 transition-all font-medium text-sm"
             >
             ...
             <div className="grid grid-cols-2 gap-3">
                <a 
                  ...
                  className="flex items-center justify-center gap-2 border border-gray-200 py-3 rounded-full hover:bg-gray-50 transition-all font-medium text-sm"
                >
                ...
                <a 
                  ...
                  className="flex items-center justify-center gap-2 border border-gray-200 py-3 rounded-full hover:bg-gray-50 transition-all font-medium text-sm text-[rgb(88,101,242)]"
                >
